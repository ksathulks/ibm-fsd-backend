...
public class EmployeeMain {
	...
	public static void main(String[] args) {
		...
		do {
			try {
				Scanner sc=new Scanner(System.in);
				System.out.println("Enter 1 to add / 2 to view / 3 to update / 4 to delete / 5 to view all / 6 to import / 7 to export --> Employee / 10 to exit");
				choice = sc.nextInt();				
				switch(choice) {
					case 1:
						try {
